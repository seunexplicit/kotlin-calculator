package com.xplicit.calculator.data
...
class Operators(private val context:Context){
    ...
    fun operatorMap():Map<String, OperatorMap>{
        return mapOf(
            ...
            context.getString(R.string.exp_power) to OperatorMap(context.getString(R.string.e_exp_power), context.getText(R.string.d_exp_power)),
